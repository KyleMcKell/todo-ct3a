	...
	return (
		<>
			...
			<main className="bg-black h-full">
				<div className="pt-6 text-2xl text-blue-500 flex justify-center items-center w-full flex-col gap-8 mx-auto">
					<h1 className="font-bold text-blue-700 text-9xl">
						LAME ASS TODO LIST
					</h1>
					...
					{status === 'authenticated' ? (
						<button
							className="border-4 border-sky-700 px-8 py-2 hover:bg-sky-900 hover:text-sky-100"
							onClick={() => signOut()}
						>
							Sign Out
						</button>
					...
					{status === 'authenticated' && (
						<>
							<form className="flex gap-8" onSubmit={handleSubmit}>
								...
								<input
									className=" px-5 text-base bg-slate-700 text-slate-50"
									type="text"
									value={todoText}
